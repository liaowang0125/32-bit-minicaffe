...
const V1LayerParameter_LayerType V1LayerParameter_LayerType_LayerType_MAX = V1LayerParameter_LayerType_BN;
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.ROIPoolingParameter roi_pooling_param = 177;
  bool has_roi_pooling_param() const;
  void clear_roi_pooling_param();
  static const int kRoiPoolingParamFieldNumber = 177;
